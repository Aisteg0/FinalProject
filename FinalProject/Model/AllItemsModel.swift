...
struct DataItem: Codable {
    let id: String?
    let internalID, licenseID: Int?
    let messengerType, phone, username, name: String?
    let image: String?
    let unreadMessages, timeLastInMessage: Int?
    let lastMessage: LastMessage?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case messengerType, phone, username, name, image, unreadMessages, timeLastInMessage, lastMessage
    }
}
